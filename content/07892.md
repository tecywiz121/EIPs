...
3. **Enhanced Stability with New Scaling Technologies**
   - Major scaling upgrades (e.g. [EIP-7594](./07594.md)), introduce uncertainty in optimal blob limits.
...
To facilitate these changes on the execution layer, the `blobSchedule` object specified in [EIP-7840](./07840.md) is extended to allow for an arbitrary number of block timestamps at which these parameters **MAY** change.
