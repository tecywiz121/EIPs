...
Introduce code validation at contract creation time for EOF formatted ([EIP-3540](./03540.md))
...
See [Security Considerations of EIP-3540](./03540.md#security-considerations).
