...
*Remark:* We rely on the notions of *operand stack* and *type section* as defined by [EIP-4750](./04750.md).

Each code section is validated independently.

#### Instructions validation

In the first validation phase defined in [EIP-3670](./03670.md) (and extended by [EIP-4200](./04200.md) and [EIP-4750](./04750.md)) instructions are inspected independently to check if their opcodes and immediate values are valid.
