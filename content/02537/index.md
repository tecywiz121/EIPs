...
Implementations SHOULD use the optimized subgroup check method detailed in a dedicated [document](./assets/fast_subgroup_checks.md).
...
The algorithms and set of parameters for SWU mapping method are provided by a separate [document](./assets/field_to_curve.md)
...
Test vectors can be found [in the test vectors files](./assets/test-vectors.md).

### Benchmarking test cases

A set of test vectors for quick benchmarking on new implementations is located in a separate [file](./assets/bench_vectors.md)

## Reference Implementation

There are two fully spec compatible implementations on the day of writing:

- One in Rust language that is based on the [EIP-196](../00196.md) code and integrated with OpenEthereum for this library
