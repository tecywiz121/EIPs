...
Introduce a new EVM instruction to [EOF](./07692.md) that allows smart contracts to create (and update) delegation accounts that match [EIP-7702](./07702.md)'s design. These accounts can be used similarly to [ERC-1167](./01167.md) clones, with significant advantages.
