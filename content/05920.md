...
| Constant                   | Definition                |
| -------------------------- | ------------------------- |
| `WARM_STORAGE_READ_COST`   | [EIP-2929](./02929.md) |
| `COLD_ACCOUNT_ACCESS_COST` | [EIP-2929](./02929.md) |
...
`PAY` cannot be implemented on networks with empty accounts (see [EIP-7523](./07523.md)).
