...
This EIP informationally defines the "Safe Range" and "Max Range" of ChainId based on a few known restrictions such as [EIP-155](./00155.md) and major wallet and JSON-RPC representation of ChainId.
